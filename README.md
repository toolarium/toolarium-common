...
[![Maven Central](https://img.shields.io/maven-central/v/com.github.toolarium/toolarium-common/0.7.1)](https://search.maven.org/artifact/com.github.toolarium/toolarium-common/0.7.1/jar)
...
```groovy
dependencies {
    implementation "com.github.toolarium:toolarium-common:0.7.1"
}
```
